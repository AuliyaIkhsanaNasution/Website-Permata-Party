  ...
  <div class="container mx-auto mt-8">
    ...
    <nav class="bg-gray-500 p-4 flex justify-between items-center rounded-lg">
      ...
      <div class="flex space-x-4">
        <a href="index.php" class="text-lg text-yellow-300 hover:text-gray-800 transition duration-300 active:text-blue-700 active:underline">Data Pesanan / </a>
    ...
    <?php
        if (isset($_GET['sukses'])) : ?>
          <script> alert ("Data Pesanan Berhasil Diedit")</script>
        <?php endif; ?>
      ...
      <table class="w-full text-center bg-white border border-gray-500 rounded-lg overflow-hidden">
        <thead class="bg-gray-400">
          <tr>
            ...
            <th class="py-2 px-4 border-b" colspan="2" >Opsi</th>
          </tr>
        </thead>
        <tbody>
          <tr>
          ...
          ?>
            ...
            <td class="py-2 px-4 border-b"><a href="deletepesanan.php?id= <?php echo $a['id'];?>" onclick=" return confirm ('Apakah Anda Yakin Ingin Menghapus data Ini ?');"><i class="material-icons">delete</i></a></td>
            <td class="py-2 px-4 border-b"><a href="editpesanan.php?id= <?php echo $a['id'];?>"><i class="material-icons">edit</i></a></td>
          </tr>
