...
<body class=" overflow-x-hidden bg-cover bg-center h-screen" style="background-image: url('../img/bgpermata.png');">
  ...
  <section id="home" data-aos="fade-down">
    ...
    <h1 class="text-3xl ms-5 trac text-cyan-100 font-extrabold inline tracking-wider absolute top-36 left-0 w-2/3 lg:ms-24 lg:w-1/2 lg:text-7xl lg:top-44" style="font-family: 'Great Vibes';">
  ...
  <section id="about" data-aos="fade-right">
    <div class="flex flex-wrap justify-center px-5 my-24">
      ...
      <div class="w-full mt-10 lg:w-1/2 lg:mt-0">
        <h2 class="text-white text-3xl font-bold mb-2 lg:text-right lg:mb-8 lg:text-7xl" style="font-family: 'Great Vibes';">About Us</h2>
        <div class="bg-slate-300 p-2 rounded-lg text-base font-[lora] font-normal text-slate-900 lg:text-sm xl:text-base lg:pb-1 lg:rounded-l-none xl:pb-2">
          <p class="py-1  indent-10">
  ...
  <!-- service -->
  <section id="service" data-aos="fade-right">
    <div class="flex flex-wrap justify-center gap-5 px-5 my-24">
      <div class="w-full lg:w-1/2">
        <h2 class="text-white text-3xl font-bold mb-2 lg:mb-8 lg:text-8xl" style="font-family: 'Great Vibes';">Service</h2>
        <div class="bg-slate-300 pb-5 p-2 rounded-lg text-base font-[lora] font-normal text-slate-900 lg:text-sm xl:text-base lg:pb-1 xl:pb-3">
          <p class="py-1 indent-10">layanan apa aja sih yang dimiliki permata party??</p>
          <p class="py-1 indent-10">
          ...
          <a href="../layanan/layanan.php" class="py-1 font-[lora] text-cyan-600 hover:text-gray-200">Lihat layanan selengkapnya >></a>
        </div>
      </div>
  ...
  <!-- gallery -->
  <section id="galery" data-aos="zoom-in-up" class="py-16 px-5">
    <h2 class="text-3xl font-bold text-white mb-5 ms-5 lg:text-8xl lg:font-extrabold" style="font-family: 'Great Vibes';">Gallery</h2>
    <div class="container">
      <div class="mySlides">
    ...
    <div class="row" data-aos="zoom-in-up">
      ...
      <div class="column">
        <img class="demo cursor" src="../img/pelaminan2.jpeg" style="width: 100%" onclick="currentSlide(2)" alt="PELAMINAN" />
      </div>
      <div class="column">
        <img class="demo cursor" src="../img/makeup1.jpeg" style="width: 100%" onclick="currentSlide(3)" alt="MAKEUP" />
      </div>
      <div class="column">
        <img class="demo cursor" src="../img/makeup2.jpeg" style="width: 100%" onclick="currentSlide(4)" alt="MAKE UP" />
      </div>
      <div class="column">
        <img class="demo cursor" src="../img/gaun1.jpeg" style="width: 100%" onclick="currentSlide(5)" alt="GAUN" />
      </div>
      <div class="column">
        <img class="demo cursor" src="../img/gaun2.jpeg" style="width: 100%" onclick="currentSlide(6)" alt="GAUN" />
      </div>
  ...
  <!-- help -->
  <section id="help" class="bg-slate-700 ps-5 pb-10 mt-20">
    <h2 class="text-3xl font-bold text-white pt-10 pb-5 ms-5 text-center lg:text-7xl lg:font-extrabold" data-aos="fade-right" style="font-family: 'Great Vibes';">Help Me!</h2>
    <p class="text-center text-xs font-[lora] text-white lg:text-base" data-aos="fade-left">Anda memiliki kritik, saran, atau pertanyaan? Isi formulir dibawah dan dapatkan jawaban melalui Email anda</p>

    <div class="form flex justify-center font-[lora] " data-aos="fade-right">
      <form action="proseshelp.php" method="post">
        <?php
        ...
        <label for="nama" class="text-lg text-cyan-600 font-bold block mt-3 lg:text-2xl"> Nama Anda</label>
        <input type="text" name="nama" placeholder="Masukkan Nama" required autocomplete="off" class="w-64 rounded-md lg:w-80" />

        <label for="email" class="text-lg text-cyan-600 font-bold block mt-3 lg:text-2xl">Email Anda</label>
        ...
        <label for="saran" class="text-lg text-cyan-600 font-bold block mt-3 lg:text-2xl">Kritik / Saran / Pertanyaan</label>
    ...
    <div class="m-auto font-[lora]" data-aos="fade-left">
      <p class="text-center text-sm text-white mt-8 lg:text-xl">Jika anda membutuhkan jawaban cepat, ajukan pertanyaan melalui <span class="text-cyan-500 font-bold text-lg lg:text-2xl">media sosial</span> kami.</p>
  ...
  <footer class="py-5" data-aos="zoom-out">
    <p class="text-white text-xs font-[lora] font-light text-center lg:text-base lg:font-normal">All Right Reserved, Copyrigth &copy; Create & Desain by <a href="https://instagram.com/permata.deco?igshid=OGQ5ZDc2ODk2ZA" target="_blank" class="text-cyan-300">Permata Party</a></p>
  </footer>
