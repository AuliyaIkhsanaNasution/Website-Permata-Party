...
<head>
  ...
  <title>Harga Wedding Gaun</title>
...
<body class=" overflow-x-hidden bg-cover bg-center h-screen font-[lora]" style="background-image: url('../../img/bgpermata.png');">
  ...
  <section data-aos="zoom-in-up">
    <img src="../../img/gaun1.jpeg" alt="hero" class="block h-screen w-screen object-cover brightness-[20%]" />
    <h1 class="text-3xl ms-5 text-cyan-100 font-extrabold tracking-wide absolute top-36 left-0 w-2/3 lg:ms-24 lg:w-1/2 lg:text-7xl lg:top-25" style="font-family: 'Great Vibes';">
      <span class="font-extrabold text-cyan-600">Permata Party</span> Mempersembahkan Kisah Cinta Anda dengan Gaun Pengantin Terindah
    </h1>
  </section>
  <!-- akhir hero -->
  ...
  <section data-aos="fade-left">
    <div class="px-4 my-24">
      <div class="max-w-3xl mx-auto">
        <h1 class="text-white text-3xl font-bold text-center mb-2 lg:mb-8 lg:text-6xl" style="font-family: 'Great Vibes';">Harga gown Wedding Perpaket</h1>
        <div class="container mx-auto py-4">
          <div class="flex flex-wrap content-center font-[lora] -mx-4">
            <div class="w-full sm:w-1/2 md:w-1/3 p-4 cursor-pointer s">
              <a href="#form">
                <div class="bg-white hover:bg-yellow-300 hover:scale-110 transition-all rounded-lg p-4 shadow">
                  <h2 class="text-xl font-semibold mb-2">Paket Elegan dan Sederhana</h2>
                  <p class="text-gray-600">
                    <span class="font-semibold">include:</span> Wedding gown dengan desain elegan dan sederhana, Baju adat pernikahan yang sesuai dengan tradisi atau budaya Anda, Aksesori seperti veil, selendang, dan mahkota, Uji fitting
                    dan penyesuaian, Fotografer untuk sesi pemotretan pre-wedding
                  </p>
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 p-4 cursor-pointer">
              <a href="#form">
                <div class="bg-white hover:bg-yellow-300 hover:scale-110 transition-all rounded-lg p-4 shadow">
                  <h2 class="text-xl font-semibold mb-2">Paket Mewah dan Kustom</h2>
                  <p class="text-gray-600">
                    <span class="font-semibold">include:</span> Wedding gown kustom yang dirancang sesuai dengan selera Anda, Baju adat pernikahan yang mewah dan eksklusif, Aksesori mewah seperti veil, selendang, dan mahkota, Uji fitting
                    dan penyesuaian, Sesi pemotretan pre-wedding dengan fotografer dan videografer, Layanan pengiriman dan penyimpanan pakaian pernikahan
                  </p>
                  <p class="text-2xl font-semibold mt-2">Rp 5.500.000</p>
                </div>
              </a>
            </div>
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 p-4 cursor-pointer">
              <a href="#form">
                <div class="bg-white hover:bg-yellow-300 hover:scale-110 transition-all rounded-lg p-4 shadow">
                  <h2 class="text-xl font-semibold mb-2">Paket Glamour dan tradisional</h2>
                  <p class="text-gray-600">
                    <span class="font-semibold">include:</span>Wedding gown mewah dengan desain eksklusif, Baju adat pernikahan yang sangat mewah, Aksesori mewah seperti veil, selendang, dan mahkota, Uji fitting dan penyesuaian, Sesi
                    pemotretan pre-wedding dengan fotografer dan videografer, Layanan transportasi untuk pengantin dan pakaian, Penggunaan wedding planner untuk membantu mengatur seluruh pernikahan, Hadiah kenang-kenangan eksklusif untuk
                    pasangan
                  </p>
                  <p class="text-2xl font-semibold mt-2">Rp 7.000.000</p>
                </div>
              </a>
            </div>
          </div>
  ...
  <section data-aos="fade-right">
    <div class="px-4 my-24">
      <div class="max-w-3xl mx-auto">
        <h1 class="text-white text-3xl font-bold text-center mb-2 lg:mb-8 lg:text-6xl" style="font-family: 'Great Vibes';">Foto Foto Gaun</h1>

        <div class="container mx-auto">
          <div class="flex flex-wrap -m-5">
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun1.jpeg" alt="Foto 1" class="w-full object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
            <div class="w-full md:w-1/3 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun2.jpeg" alt="Foto 2" class="w-full object-cover hover:scale-150 transition-all rounded-lg" />
              </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun3.jpeg" alt="Foto 1" class="w-100 object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun4.jpeg" alt="Foto 1" class="w-full object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
            <div class="w-full md:w-1/3 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun5.jpeg" alt="Foto 2" class="w-full object-cover hover:scale-150 transition-all rounded-lg" />
              </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun6.jpeg" alt="Foto 1" class="w-100 object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun7.jpeg" alt="Foto 1" class="w-full object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
            <div class="w-full md:w-1/3 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun8.jpeg" alt="Foto 2" class="w-full object-cover hover:scale-150 transition-all rounded-lg" />
              </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 p-4">
              <div class="rounded-lg shadow-md">
                <img src="../../img/gaun9.jpeg" alt="Foto 1" class="w-100 object-cover hover:scale-150 transition-all rounded-lg cursor-pointer" />
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="form" data-aos="fade-left">
    ...
    <div class="outline outline-offset-1 font-[lora] outline-[#1e293b] w-2/3 mx-auto bg-gradient-to-r from-[#c0b7ee] to-[#6259dd] p-6 rounded-md shadow-md">
      <h1 class="text-2xl font-semibold mb-4">Form Pemesanan</h1>
      <form method="post" action="prosesgaun.php">
        <div class="mb-4">
          <label for="nama" class="block text-gray-900 font-semibold">Nama Pemesan</label>
        ...
        <div class="mb-4">
          <label for="tanggal" class="block text-gray-900 font-semibold">Tanggal Acara</label>
          <input type="date" id="tanggal" name="tanggal" class="w-full p-3 border rounded-md" required />
        </div>
        <div class="mb-5">
          <label for="paket" class="block text-gray-900 font-semibold">Paket Acara</label>
          <select id="paket" name="paket" class="w-full p-3 border rounded-md" required>
            <option selected>--PILIH PAKET--</option>
            <option value="elegan">Paket Elegan dan Sederhana (4jt)</option>
            <option value="mewah">Paket Mewah dan Kustom (5,5jt)</option>
            <option value="glamour">Paket Glamour dan tradisional (7jt)</option>
          </select>
        </div>
